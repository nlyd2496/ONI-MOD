...
{
    public class A15GG1 : IBuildingConfig
    {
        ...
        public static string ID = "A15GG1";
    }
    [HarmonyPatch(typeof(BuildingFacades), MethodType.Constructor, new Type[] { typeof(ResourceSet) })]
    public static class 蓝图系统A15GG2
    {
        public static void Postfix(BuildingFacades __instance)
        {
            __instance.Add("A15GG2",
                STRINGS.BUILDINGS.PREFABS.A15GG2.NAME, STRINGS.BUILDINGS.PREFABS.A15GG2.EFFECT, PermitRarity.Universal,
                "A15GG1", "A15GG2_kanim", null);
        }
    }
}
