...
{
    public class A29GG3 : IBuildingConfig
    {
        //-------------------------------
        //以下为建筑通用属性
        public override BuildingDef CreateBuildingDef()
        {
            ...
            //-------------------------------
            buildingDef.AttachmentSlotTag = "A29GG3";
        ...
        public override void ConfigureBuildingTemplate(GameObject go, Tag prefab_tag)
        {
            ...
            {
                new BuildingAttachPoint.HardPoint(new CellOffset(0, 2), "A29GG4", null)
            };
