...
{
    public class A29GG1 : IBuildingConfig
    {
        //-------------------------------
        //以下为建筑通用属性
        public override BuildingDef CreateBuildingDef()
        {
            ...
            //-------------------------------
            buildingDef.AttachmentSlotTag = "A29GG1";
        ...
        public override void ConfigureBuildingTemplate(GameObject go, Tag prefab_tag)
        {
            ...
            {
                new BuildingAttachPoint.HardPoint(new CellOffset(0, 1), "A29GG2", null)
            };
