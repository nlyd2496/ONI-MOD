...
{
    public class C1GG1 : IEntityConfig
    {
        //--------------------------
        public const string Id = "C1GG1";// 食物ID
        public static string Name = STRINGS.CREATURES.SPECIES.C1GG1.C1;// 食物名称
        public static string EFFECT = STRINGS.CREATURES.SPECIES.C1GG1.C2;// 食物描述
        public static string DESC = STRINGS.CREATURES.SPECIES.C1GG1.C3;// 配方描述
        private const string AnimName = "C1GG1_kanim";// 食物动画
        //--------------------------
        ...
        public GameObject CreatePrefab()
        {
            ...
            var foodInfo = new EdiblesManager.FoodInfo(
                    ...
                    caloriesPerUnit: 300000f, // 食物每单位卡路里   ---   300 000
                    quality: 3, // 食物质量
            ...
            var food = EntityTemplates.ExtendEntityToFood(entity, foodInfo);
                // 添加配方
                Recipe = AddComplexRecipe(input: new[] { new ComplexRecipe.RecipeElement(B1GG3.Id, 3f) }, // 配方输入
                    output: new[] { new ComplexRecipe.RecipeElement(C1GG1.Id, 1f) }, // 配方输出
