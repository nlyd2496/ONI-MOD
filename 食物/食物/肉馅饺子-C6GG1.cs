...
{
    public class C6GG1 : IEntityConfig
    {
        //--------------------------
        public const string Id = "C6GG1";// 食物ID
        public static string Name = STRINGS.CREATURES.SPECIES.C6GG1.C1;// 食物名称
        public static string EFFECT = STRINGS.CREATURES.SPECIES.C6GG1.C2;// 食物描述
        public static string DESC = STRINGS.CREATURES.SPECIES.C6GG1.C3;// 配方描述
        private const string AnimName = "C6GG1_kanim";// 食物动画
        //--------------------------
        ...
        public GameObject CreatePrefab()
        {
            ...
            (
                input: new[]
                {
                new ComplexRecipe.RecipeElement("Meat", 1f),//肉 1600
                new ComplexRecipe.RecipeElement("ColdWheatSeed", 2f),//冰霜麦粒 400
                }, // 配方输入
                output: new[]
                {
                    new ComplexRecipe.RecipeElement(C6GG1.Id, 1f)
                }, // 配方输出
