...
{
    public class C3GG1 : IEntityConfig
    {
        //--------------------------
        public const string Id = "C3GG1";// 食物ID
        public static string Name = STRINGS.CREATURES.SPECIES.C3GG1.C1;// 食物名称
        public static string EFFECT = STRINGS.CREATURES.SPECIES.C3GG1.C2;// 食物描述
        public static string DESC = STRINGS.CREATURES.SPECIES.C3GG1.C3;// 配方描述
        private const string AnimName = "C3GG1_kanim";// 食物动画
        //--------------------------
        ...
        public GameObject CreatePrefab()
        {
            ...
            var foodInfo = new EdiblesManager.FoodInfo(
                    ...
                    caloriesPerUnit: 3300000f, // 食物每单位卡路里   ---   300 000
                    quality: 6, // 食物质量
            ...
            (
                ...
                output: new[]
                {
                    new ComplexRecipe.RecipeElement(C3GG1.Id, 1f)
                }, // 配方输出
