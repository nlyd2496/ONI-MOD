...
{
    public class C2GG1 : IEntityConfig
    {
        //--------------------------
        public const string Id = "C2GG1";// 食物ID
        public static string Name = STRINGS.CREATURES.SPECIES.C2GG1.C1;// 食物名称
        public static string EFFECT = STRINGS.CREATURES.SPECIES.C2GG1.C2;// 食物描述
        public static string DESC = STRINGS.CREATURES.SPECIES.C2GG1.C3;// 配方描述
        private const string AnimName = "C2GG1_kanim";// 食物动画
        //--------------------------
        ...
        public GameObject CreatePrefab()
        {
            ...
            var foodInfo = new EdiblesManager.FoodInfo(
                    ...
                    caloriesPerUnit: 2100000f, // 食物每单位卡路里   ---   300 000
                    quality: 6, // 食物质量
            ...
            (
                input: new[]
                {
                new ComplexRecipe.RecipeElement("FishMeat", 2f),//帕库鱼片  1000
                //new ComplexRecipe.RecipeElement("WormSuperFruit", 1f),//虫果  250
                new ComplexRecipe.RecipeElement(SpiceNutConfig.ID, 3f),//火椒粒  0
                new ComplexRecipe.RecipeElement(B1GG3.Id, 1f) // 辣椒 100
                }, // 配方输入
                output: new[]
                {
                    new ComplexRecipe.RecipeElement(C2GG1.Id, 1f)
                }, // 配方输出
