...
{
    public class C7GG1 : IEntityConfig
    {
        //--------------------------
        public const string Id = "C7GG1";// 食物ID
        public static string Name = STRINGS.CREATURES.SPECIES.C7GG1.C1;// 食物名称
        public static string EFFECT = STRINGS.CREATURES.SPECIES.C7GG1.C2;// 食物描述
        public static string DESC = STRINGS.CREATURES.SPECIES.C7GG1.C3;// 配方描述
        private const string AnimName = "C7GG1_kanim";// 食物动画
        //--------------------------
        ...
        public GameObject CreatePrefab()
        {
            ...
            var foodInfo = new EdiblesManager.FoodInfo(
                    ...
                    caloriesPerUnit: 2200000f, // 食物每单位卡路里   ---   300 000
                    quality: 6, // 食物质量
            ...
            (
                input: new[]
                {
                new ComplexRecipe.RecipeElement(PrickleFruitConfig.ID, 1f),//毛刺浆果 1600
                new ComplexRecipe.RecipeElement("ColdWheatSeed", 2f),//冰霜麦粒 400
                }, // 配方输入
                output: new[]
                {
                    new ComplexRecipe.RecipeElement(C7GG1.Id, 1f)
                }, // 配方输出
