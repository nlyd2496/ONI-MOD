...
{
    public class D1GG6 : IEntityConfig
    {
        //--------------------------
        public const string Id = "D1GG6";// 食物ID
        public static string Name =   STRINGS.CREATURES.SPECIES.D1GG6.D1;// 食物名称
        ...
        private const string AnimName = "D1GG6_kanim";// 食物动画
        //--------------------------
        ...
        public GameObject CreatePrefab()
        {
            ...
            (
                ...
                output: new[]
                {
                    new ComplexRecipe.RecipeElement(D1GG6.Id, 1f)
                }, // 配方输出
