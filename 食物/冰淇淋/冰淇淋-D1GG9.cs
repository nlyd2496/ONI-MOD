...
{
    public class D1GG9 : IEntityConfig
    {
        //--------------------------
        public const string Id = "D1GG9";// 食物ID
        public static string Name =   STRINGS.CREATURES.SPECIES.D1GG9.D1;// 食物名称
        ...
        private const string AnimName = "D1GG9_kanim";// 食物动画
        //--------------------------
        ...
        public GameObject CreatePrefab()
        {
            ...
            (
                ...
                output: new[]
                {
                    new ComplexRecipe.RecipeElement(D1GG9.Id, 1f)
                }, // 配方输出
