...
{
    public class D1GG3 : IEntityConfig
    {
        //--------------------------
        public const string Id = "D1GG3";// 食物ID
        public static string Name =   STRINGS.CREATURES.SPECIES.D1GG3.D1;// 食物名称
        ...
        private const string AnimName = "D1GG3_kanim";// 食物动画
        //--------------------------
        ...
        public GameObject CreatePrefab()
        {
            ...
            (
                ...
                output: new[]
                {
                    new ComplexRecipe.RecipeElement(D1GG3.Id, 1f)
                }, // 配方输出
