...
{
    public class B1GG0 : StateMachineComponent<B1GG0.StatesInstance>
    {
        [MyCmpReq]
        private Crop crop;
        ...
        public class StatesInstance : GameStateMachine<States, StatesInstance, B1GG0, object>.GameInstance
        {
            public StatesInstance(B1GG0 master) : base(master) { }
        ...
        public class States : GameStateMachine<States, StatesInstance, B1GG0>
        {
