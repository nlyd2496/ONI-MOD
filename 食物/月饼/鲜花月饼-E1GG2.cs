...
{
    public class E1GG2 : IEntityConfig
    {
        //--------------------------
        public const string Id = "E1GG2";// 食物ID
        public static string Name = STRINGS.CREATURES.SPECIES.E1GG2.E1;// 食物名称
        public static string EFFECT = STRINGS.CREATURES.SPECIES.E1GG2.E2;// 食物描述
        public static string DESC = STRINGS.CREATURES.SPECIES.E1GG2.E3;// 配方描述
        private const string AnimName = "E1GG2_kanim";// 食物动画
        //--------------------------
        ...
        public GameObject CreatePrefab()
        {
            ...
            var foodInfo = new EdiblesManager.FoodInfo(
                    ...
                    caloriesPerUnit: 4400000f, // 食物每单位卡路里   ---   300 000
                    quality: 3, // 食物质量
            ...
            (
                ...
                new ComplexRecipe.RecipeElement("Lettuce".ToTag(), 1f),//海生菜  400 
                new ComplexRecipe.RecipeElement("FriedMushroom", 1f),//煎蘑菇  2800+400+200+1000=4400
                }, // 配方输入
                output: new[]
                {
                    new ComplexRecipe.RecipeElement(E1GG2.Id, 1f)
                }, // 配方输出
