...
{
    public class E1GG3 : IEntityConfig
    {
        //--------------------------
        public const string Id = "E1GG3";// 食物ID
        public static string Name = STRINGS.CREATURES.SPECIES.E1GG3.E1;// 食物名称
        public static string EFFECT = STRINGS.CREATURES.SPECIES.E1GG3.E2;// 食物描述
        public static string DESC = STRINGS.CREATURES.SPECIES.E1GG3.E3;// 配方描述
        private const string AnimName = "E1GG3_kanim";// 食物动画
        //--------------------------
        ...
        public GameObject CreatePrefab()
        {
            ...
            var foodInfo = new EdiblesManager.FoodInfo(
                    ...
                    caloriesPerUnit: 3000000f, // 食物每单位卡路里   ---   300 000
                    quality: 3, // 食物质量
            ...
            (
                ...
                new ComplexRecipe.RecipeElement("WormSuperFruit", 2f),//虫果  2000+1000+200=3000
                }, // 配方输入
                output: new[]
                {
                    new ComplexRecipe.RecipeElement(E1GG3.Id, 1f)
                }, // 配方输出
