...
{
    public class A72GG2 : IBuildingConfig
    {
        //---------------------------------------------------------------------------------------------------------------------
        public override BuildingDef CreateBuildingDef()
        {
            ...
            {
                LogicPorts.Port.InputPort(A72GG1.BRIDGE_LOGIC_IO_ID, new CellOffset(-1, 0), STRINGS.BUILDINGS.PREFABS.XINHAO.LOGIC_PORT, STRINGS.BUILDINGS.PREFABS.XINHAO.LOGIC_PORT_ACTIVE, STRINGS.BUILDINGS.PREFABS.XINHAO.LOGIC_PORT_INACTIVE, false, false),
            ...
            //--------------------------
            if (控制台.Instance.信号组桥) { buildingDef.Deprecated = false; } else { buildingDef.Deprecated = true; }
            //--------------------------
            return buildingDef;
        }
        //---------------------------------------------------------------------------------------------------------------------F
