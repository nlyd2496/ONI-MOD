...
{
    public class A6GG1_KZQ : KMonoBehaviour, ISingleSliderControl, ISliderControl
    {
        ...
        //--------------------------
        [Serialize] public float AA = 26f;//AA参数默认值
        //--------------------------
        [MyCmpReq] public SteamTurbine steamTurbine;
        internal void Update() { this.steamTurbine.pumpKGRate = this.AA ; }//将AA的值赋予源功能组件
        //--------------------------
        //以下内容无需更改
        ...
        internal void OnCopySettings(object data) { var component = ((GameObject)data).GetComponent<A6GG1_KZQ>(); if (component == null) return; AA = component.AA; Update(); }
        //--------------------------
    }
}
