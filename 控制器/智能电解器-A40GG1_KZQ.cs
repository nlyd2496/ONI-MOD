...
{
    public class A40GG1_KZQ : KMonoBehaviour, ISingleSliderControl, ISliderControl
    {
        ...
        //--------------------------
        [MyCmpReq] public Electrolyzer electrolyzer1;//灯
        internal void Update() { this.electrolyzer1.maxMass = (int)this.AA; }//将AA的值赋予源功能组件
        //--------------------------
        //以下内容无需更改
        ...
        internal void OnCopySettings(object data) { var component = ((GameObject)data).GetComponent<A40GG1_KZQ> (); if (component == null) return; AA = component.AA; Update(); }
        //--------------------------
    }
}
