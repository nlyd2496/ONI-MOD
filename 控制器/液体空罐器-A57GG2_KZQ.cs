...
{
    public class A57GG2_KZQ : KMonoBehaviour, ISingleSliderControl, ISliderControl
    {
        ...
        internal void OnCopySettings(object data) { var component = ((GameObject)data).GetComponent<A57GG2_KZQ>(); if (component == null) return; AA = component.AA; Update(); }
        //--------------------------
    }
}
