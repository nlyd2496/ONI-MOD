...
{
    public class A17GG1_KZQ : KMonoBehaviour, ISingleSliderControl, ISliderControl
    {
        ...
        internal void OnCopySettings(object data) { var component = ((GameObject)data).GetComponent<A17GG1_KZQ>(); if (component == null) return; AA = component.AA; Update(); }
        //--------------------------
    }
}
