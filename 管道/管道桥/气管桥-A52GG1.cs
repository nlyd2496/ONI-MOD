...
{
    public class A52GG1 : IBuildingConfig
    {
        public override BuildingDef CreateBuildingDef()
        {
            ...
            //--------------------------
            if (控制台.Instance.跨两格气管桥) { buildingDef.Deprecated = false; } else { buildingDef.Deprecated = true; }
            //--------------------------
            return buildingDef;
        }
        ...
        public const string ID = "A52GG1";
        private const ConduitType CONDUIT_TYPE = ConduitType.Gas;
    }
    public class A52GG2 : IBuildingConfig
    {
        public override BuildingDef CreateBuildingDef()
        {
            string id = "A52GG2";
            ...
            GeneratedBuildings.RegisterWithOverlay(OverlayScreen.GasVentIDs, buildingDef.PrefabID);
            //--------------------------
            if (控制台.Instance.跨三格气管桥) { buildingDef.Deprecated = false; } else { buildingDef.Deprecated = true; }
            //--------------------------
            return buildingDef;
        }
        public override void ConfigureBuildingTemplate(GameObject go, Tag prefab_tag)
