...
{
    public class A3GG1 : BaseBatteryConfig
    {
        ...
        public override void DoPostConfigureComplete(GameObject go)
        {
            ...
            battery.capacity = SingletonOptions<控制台>.Instance.一格电池容量;//容量
            battery.joulesLostPerSecond = SingletonOptions<控制台>.Instance.一格电池损耗;//损耗
            base.DoPostConfigureComplete(go);
        }
        public const string ID = "A3GG1";
    }
}
