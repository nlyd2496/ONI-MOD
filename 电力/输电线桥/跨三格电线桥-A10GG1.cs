...
{
    public class A10GG1 : IBuildingConfig
    {
        public override BuildingDef CreateBuildingDef()
        {
            ...
            GeneratedBuildings.RegisterWithOverlay(OverlayScreen.WireIDs, "A10GG1");
            // 如果控制台的实例的a1属性为真，执行以下代码
            if (控制台.Instance.跨三格电线桥)
            {
