...
{
    public class A7GG1 : IBuildingConfig
    {
        public override BuildingDef CreateBuildingDef()
        {
            ...
            GeneratedBuildings.RegisterWithOverlay(OverlayScreen.WireIDs, "A7GG1");
            // 如果控制台的实例的a1属性为真，执行以下代码
            if (控制台.Instance.跨两格导线桥)
            {
